...
> **Trước khi cài, chọn 1 trong 2 cách chạy:**
> - **Tự build/tự chạy từ mã nguồn này** (theo hướng dẫn dưới) → **100% offline, miễn phí, không kết nối máy chủ nào**, kể cả bước dịch (mặc định dịch tay: app ghi sẵn lời nhắc, bạn dán vào ChatGPT/Gemini).
> - **Tải bản `.exe` build sẵn từ tác giả** (nếu có công bố ở trang GitHub) → phần lồng tiếng chính vẫn miễn phí/offline như trên, nhưng bản build sẵn thường trỏ tới máy chủ của tác giả để bật tính năng **dịch tự động** (tốn Vox — hệ tín dụng trả trước, xem trang Tài khoản trong app). Đây không phải yêu cầu bắt buộc — bạn luôn tắt được ở Cài đặt và quay về dịch tay.
>
> App tự nói rõ đang ở chế độ nào ngay màn chào lần đầu, và trang Trợ giúp (mục "Ứng dụng này có tốn phí không?") — không đoán, không giấu.
