...
EXTRA_PROBLEMS = (
    ("Ứng dụng này có tốn phí không?",
     "Không. Toàn bộ pipeline chính — tải video, tách nhạc nền, nghe-chép, "
     "đọc bằng giọng Việt, ghép video, phụ đề — chạy 100% trên máy bạn, "
     "miễn phí, không giới hạn. Chỉ riêng tính năng DỊCH TỰ ĐỘNG qua máy "
     "chủ (nếu bạn dùng bản có cấu hình máy chủ) mới tốn Vox; không có máy "
